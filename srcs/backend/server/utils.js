...
async function replace_all_templates(request, response) {
	...
	const friends_html_raw = await fs.readFile("./templates/friends.html", 'utf8');
	// const friends_html = friends_html_raw.replace('{{FRIEND_REQUESTS}}', await friends_request.show_pending_requests(userid));
	const home_html_raw = await fs.readFile("./templates/home.html", 'utf8');
	const login_html_raw = await fs.readFile("./templates/login.html", 'utf8');
	var login_html = login_html_raw.replace("{{google_login}}", google_login);
	login_html = login_html.replace("{{github_login}}", github_login);
	const register_html_raw = await fs.readFile("./templates/register.html", 'utf8');
	...
	const profile_html_raw = await fs.readFile("./templates/profile.html", 'utf8');
	const settings_html_raw = await fs.readFile("./templates/settings.html", 'utf8');

	var settings_html_default_string = "";
	settings_html_default_string += '<div class="buttons mb-6" onclick="window.location.href = \'http://localhost:8080/settings/mfa\'">';
	...
	settings_html_default_string += '<div class="buttons mb-6" onclick="window.location.href = \'http://localhost:8080/settings/user\'">';
	settings_html_default_string += '<button class="block w-full mb-6 mt-6">';
	...
	settings_html_default_string += '<button onclick="window.location.href = \'http://localhost:8080\'" class="flex items-center gap-4 bg-gradient-to-br to-[#d16e1d] from-[#e0d35f] from-5% border-black border border-spacing-5 rounded-xl px-6 py-4 w-full">';
	...
	settings_html_mfa_string += '<button onclick="window.location.href=\'http://localhost:8080/settings\'" class="flex items-center gap-4 bg-gradient-to-br to-[#d16e1d] from-[#e0d35f] from-5% border-black border border-spacing-5 rounded-xl px-6 py-4 w-full">';
	...
	settings_html_user_string += '<div class="buttons mb-6" onclick="window.location.href = \'http://localhost:8080/settings/user/select_language\'">';
	...
	settings_html_user_string += '<div class="buttons mb-6" onclick="window.location.href = \'http://localhost:8080/settings/user/profile_settings\'">';
	settings_html_user_string += '<button class="block w-full mb-6 mt-6">';
	...
	settings_html_user_string += '<button onclick="window.location.href = \'http://localhost:8080/settings\'" class="flex items-center gap-4 bg-gradient-to-br to-[#d16e1d] from-[#e0d35f] from-5% border-black border border-spacing-5 rounded-xl px-6 py-4 w-full">';
	...
	settings_html_user_select_language_string += '<button onclick="window.location.href = \'http://localhost:8080/settings\'">back</button> \
	...
	const game_raw = await fs.readFile("./templates/game.html", 'utf8');

	const menu_raw = await fs.readFile("./templates/menu.html", 'utf8');

	const index_html_raw = await fs.readFile("./templates/index.html", 'utf8')
