...
async function replace_all_templates(request, response) {
	...
	var play_main = "";
	play_main += '<div id="play_div" class="">';
	...
	play_main +=       '</div>';
	play_main +=       '<div id="game-container" style="display: none;">';
	play_main +=         '<h2 id="game-mode-title"></h2>';
	play_main +=         '<canvas id="game" width="800" height="600" style="background:#000; display:block; margin:0 auto"></canvas>';
	play_main +=       '</div>';
	play_main +=       '<div id="matchmaking-page" style="display: none; padding: 2rem; font-family: sans-serif; text-align: center;">';
	play_main +=         '<h2>Searching for an opponent…</h2>';
	play_main +=         '<div id="matchmaking-spinner" style="margin: 1.5rem auto; width: 50px; height: 50px; background: #666; border-radius: 50%; animation: spin 1s linear infinite;"></div>';
	play_main +=         '<button id="cancel-matchmaking-btn" class="full-btn" style="width: 200px; height: 60px; font-size: 1.2rem;">';
	play_main +=           'Cancel Search';
	play_main +=         '</button>';
	play_main +=       '</div>';
	play_main +=       '<style>';
	play_main +=         '@keyframes spin { to { transform: rotate(360deg); } }';
	play_main +=       '</style>';
	play_main +=       '<div id="tournament-page" style="display:none; padding:2rem; font-family:sans-serif">';
	...
	play_main +=         '</div>';
	play_main +=       '</div>';
	play_main +=       '<div id="t-lobby-page" style="display:none;padding:2rem;font-family:sans-serif">';
