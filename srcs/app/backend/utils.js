...
async function replace_all_templates(request, response, state, override) {
	...
	play_main +=           '<input id="t-code-input" class="full-btn flex-1 h-[100px]" placeholder="Enter a Tournament code here">';
	play_main +=           '<button id="t-code-btn" class="full-btn w-[180px] h-[100px]">Join<br>by&nbsp;code</button>';
	play_main +=         '</div>';
	play_main +=         '<div class="mb-8 text-center">';
	play_main +=           '<button id="t-create-btn" class="full-btn w-60 h-[60px] text-lg">Create&nbsp;Tournament</button>';
	play_main +=         '</div>';
	...
	play_main +=         '<button id="t-start-btn" class="full-btn w-80 h-[80px] text-2xl">START</button>';
	play_main +=       '</div>';
	play_main +=       '<div id="player-controls">';
	play_main +=         '<button id="t-ready-btn" class="full-btn w-80 h-[80px] text-2xl">READY</button>';
	play_main +=         '<span id="t-my-ready-dot" class="green-dot"></span>';
	play_main +=       '</div>';
	play_main +=       '<div class="flex justify-between">';
