...
function returnLogin() {
    return `
    <label for="email-input" class="label_text">Email</label>
    <div class="relative">
        <div class="input_svg">
        ...
        <input type="text" id="email-input" placeholder="example@gmail.com" required class="input_field" />
    </div>
    ...
    <div class="relative">
        ...
        <button onclick="toggle_Eye(3)" id="password_eye1" class="password_eye" tabindex="-1">
            <svg class="w-6 h-6 text-gray-500 justify-center" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
        ...
        <input type="password" id="password-input1" placeholder="Password" required class="input_field" />
    </div>
    <button id="login-button" onclick="login()" class="mt-4 bg-violet-700 hover:bg-violet-800 text-white font-bold py-2 text-lg rounded-xl w-full mb-4 transition-all">
        Login
    </button>
