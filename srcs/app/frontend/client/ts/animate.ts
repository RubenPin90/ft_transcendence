...
//duplicate in user_settings.ts but dont if i cant export these functions since for whatever reson it fucks up everything and with this methong both work so ¯\_(ツ)_/¯
function eye_One(){
