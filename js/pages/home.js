...
//             <div class="bg-gray-600 rounded-3xl p-10 mx-5 bg-clip-padding backdrop-filter backdrop-blur-xl bg-opacity-30 border-white border-r border-l border-b shadow-xl shadow-black"> <!--TODO fix for smaller devices CHANGE BG-COLLOR! MAKE IT TRANSPARRENT LIKE GLASS ADD SHADDOW-->
...
//                     <div class="w-7/8">
//                         <button type="button" class="text-white bg-[#221f1f] border border-[#221f1f] font-medium rounded-xl text-lg px-5 py-2.5 text-center inline-flex items-center me-2 mb-2 w-full">
...
//         <button id="login-button" onclick="toggle_login()" class="border-black border border-spacing-1 bg-red-400 lg:p-4 sm:p-4 md:p-4 lg:text-6xl sm:text-4xl rounded-lg">Login</button>  <!--TODO ADD CUSTOM FONT-->
//     </div>
//   `;
// }
